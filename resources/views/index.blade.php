    ...
    <div class="main overflow-hidden">
        ...
        <header id="header">
            ...
            <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand">
                <div class="container header bg-blue-400">
                    <!-- Navbar Brand-->
                    ...
                    <ul class="navbar-nav action">
                        <li class="nav-item ml-3">
                            <a href="{{ route('login') }}" class="btn ml-lg-auto btn-bordered-white"><i class="fas fa-user contact-icon mr-md-2"></i>Login</a>
                        </li>
                    </ul>
                </div>
            </nav>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-7">
                        <div class="welcome-intro">
                            <h1 class="text-black mb-2">Get the #1 Web Hosting</h1>
                            <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident ipsa dicta doloribus, mollitia pariatur. Illum excepturi vel hic quasi accusamus.</p>
                            <!-- Content List -->
                            <ul class="content-list mt-3 mb-2">
                                <!-- Single Content List -->
                                <li class="single-content-list media text-black py-1">
                            ...
                            <span class="d-block font-italic text-black">Starting at $0.99/month*</span>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-md-6">
                        <div class="section-heading mb-3">
                            <h2 class="text-black mb-3">Our platform is powered by Google Cloud</h2>
                            <p class="text-black">Whether you are looking for a personal website hosting plan or a business website hosting plan, Hosting is the perfect solution for you. Our powerful website hosting services will not only help you achieve your overall website goals, but will also provide you with the confidence you need in knowing that you are partnered with a reliable and secure website hosting platform.</p>
                        </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <ul class="content-list text-left pt-4 pt-md-0">
                            ...
                            <li class="single-content-list media py-3">
                                <div class="content-icon pr-4">
                                    <i class="pe-7s-graph pe-4x text-black"></i>
                                </div>
                                <div class="content-text media-body">
                                    <h3 class="text-black mb-2">SSD persistent storage</h3>
                                    <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis, distinctio.</p>
                                </div>
                            </li>
                            <!-- Single Content List -->
                            <li class="single-content-list media py-3">
                                <div class="content-icon pr-4">
                                    <i class="pe-7s-diamond pe-4x text-black"></i>
                                </div>
                                <div class="content-text media-body">
                                    <h3 class="text-black mb-2">Proficient &amp; Friendly</h3>
                                    <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis, distinctio.</p>
                                </div>
                            </li>
                            <!-- Single Content List -->
                            <li class="single-content-list media py-3">
                                <div class="content-icon pr-4">
                                    <i class="pe-7s-rocket pe-4x text-black"></i>
                                </div>
                                <div class="content-text media-body">
                                    <h3 class="text-black mb-2">Extremely Fast</h3>
                                    <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis, distinctio.</p>
                                </div>
                            </li>
                            <!-- Single Content List -->
                            <li class="single-content-list media py-3">
                                <div class="content-icon pr-4">
                                    <i class="pe-7s-headphones pe-4x text-black"></i>
                                </div>
                                <div class="content-text media-body">
                                    <h3 class="text-black mb-2">24/7 Support</h3>
                                    <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis, distinctio.</p>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-md-8">
                        ...
                        <div class="section-heading m-0">
                            <h2 class="text-black">Sign up for web hosting today!</h2>
                            <p class="text-black d-none d-sm-block mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati dignissimos quae quo ad iste ipsum officiis deleniti asperiores sit.</p>
                            <p class="text-black d-block d-sm-none mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati.</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <!-- CTA Content -->
                        <div class="cta-content pt-4 pt-md-0">
                            <h3 class="d-block text-black fw-4">Starting at<br> <span>$0.99/month*</span></h3>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                <!-- Copyright Left -->
                                <div class="copyright-left text-black-50">&copy; 2021 Hostbit All rights reserved.</div>
                                <!-- Copyright Right -->
                                <div class="copyright-right text-black-50">Made with <i class="fas fa-heart"></i> By <a href="#">Themeland</a></div>
                            </div>
                        </div>
                    </div>
                </div>
